...
return (
    <div className="flex items-center justify-center min-h-[1000px]">
        <div className="max-w-[340] items-center md:max-w-4xl w-full border-l-4 border-b-4 border-gray-500 bg-white rounded-lg shadow-lg overflow-hidden flex flex-col">
